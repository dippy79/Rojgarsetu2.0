  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-6 text-center">
        <Link href="/" className="text-3xl font-extrabold text-stone-900 tracking-tight">
          Rojgar<span className="text-stone-800">Setu</span>
        </Link>
      ...
      <div className="max-w-md mx-auto bg-white/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-stone-200/60 w-full">
        {/* Tab Navigation */}
        ...
        {error && (
          <div className="mb-4 p-3 bg-stone-50 text-stone-600 text-xs rounded-xl border border-stone-100 font-medium">
            {error}
          </div>
        )}
        ...
        {activeTab === 'login' && (
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-2.5 bg-stone-900 text-white rounded-xl text-sm font-semibold hover:bg-stone-950 transition-all shadow-md disabled:opacity-50"
            >
        ...
        {activeTab === 'register' && (
          <form onSubmit={handleRegisterSubmit} className="space-y-3">
            ...
            <div>
              <label className="block text-xs font-semibold text-stone-700 mb-1">Register As</label>
              <select
