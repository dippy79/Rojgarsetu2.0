              ...
              <div key={m.job_id || idx} className="group bg-white border border-slate-200 rounded-[2.5rem] p-8 hover:border-stone-400 hover:shadow-2xl hover:shadow-stone-500/5 transition-all relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="space-y-4 relative z-10 flex-1">
                  <div className="flex items-center gap-3">
                    <div className="px-4 py-1.5 bg-stone-600 text-white rounded-full flex items-center gap-2 text-[10px] font-black uppercase tracking-widest shadow-lg shadow-stone-600/20">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(m.matched_skills || []).map(s => (
                      <span key={s} className="bg-stone-50 text-stone-700 text-[9px] font-black uppercase px-3 py-1 rounded-lg border border-stone-100 flex items-center gap-1.5">
