        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-stone-900 text-white p-6 rounded-2xl shadow-xl shadow-stone-900/20">
                <h3 className="text-sm font-bold mb-2">Recruiter Pro</h3>
                <p className="text-xs text-stone-200 mb-4">Unlock advanced analytics, AI candidate matching, and premium badges.</p>
                <button className="w-full bg-stone-500 hover:bg-stone-400 text-white py-2 rounded-lg text-xs font-bold transition">
                  Upgrade Plan
                </button>
              </div>
            </div>
