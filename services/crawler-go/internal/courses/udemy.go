...
func NewUdemySource() *UdemySource {
	return &UdemySource{
		BaseSource: shared.BaseSource{NameStr: "udemy", BaseURL: "https://www.udemy.com"},
		client: &http.Client{
...
func (s *UdemySource) Fetch(ctx context.Context) ([]shared.CourseSource, error) {
...
func (s *UdemySource) fetchFromWebsite(ctx context.Context) ([]shared.CourseSource, error) {
	urls := []string{
...
func (s *UdemySource) parseHTMLCourses(html string) []shared.CourseSource {
	var courses []shared.CourseSource
