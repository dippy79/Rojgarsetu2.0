...
func NewNSDCSource() *NSDCSource {
	return &NSDCSource{
		BaseSource: BaseSource{NameStr: "nsdc", BaseURL: "https://www.nsdcindia.org"},
		client: &http.Client{
...
func (s *NSDCSource) Fetch(ctx context.Context) ([]CourseSource, error) {
...
func (s *NSDCSource) fetchFromWebsite(ctx context.Context) ([]CourseSource, error) {
	urls := []string{
...
func (s *NSDCSource) parseHTMLCourses(html, baseURL string) []CourseSource {
	var courses []CourseSource
